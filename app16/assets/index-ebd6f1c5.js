...
const Questionnaire_vue_vue_type_style_index_0_lang = "";
const _hoisted_1$1 = { class: "score-container" };
const _hoisted_2 = /* @__PURE__ */ createBaseVNode("span", null, " Score: ", -1);
const _hoisted_3 = { id: "score" };
const _hoisted_4 = {
  id: "question-container",
  class: "d-flex align-items-center"
};
const _hoisted_5 = { id: "question" };
const _hoisted_6 = { action: "#" };
const _hoisted_7 = { class: "form-floating mb-3" };
const _hoisted_8 = ["disabled"];
const _hoisted_9 = /* @__PURE__ */ createBaseVNode("label", { for: "answerInput" }, "Type your answer here", -1);
const _hoisted_10 = {
  key: 0,
  class: "skipped-question"
};
const _hoisted_11 = /* @__PURE__ */ createBaseVNode("span", null, " Answer: ", -1);
const _hoisted_12 = { id: "answer" };
const _sfc_main$1 = {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", null, [
        createBaseVNode("div", _hoisted_1$1, [
          _hoisted_2,
          createBaseVNode("span", _hoisted_3, toDisplayString(unref(store).score), 1)
        ]),
        createBaseVNode("div", _hoisted_4, [
          createBaseVNode("p", _hoisted_5, toDisplayString(unref(store).data[unref(store).dataIndex].question), 1)
        ]),
        createBaseVNode("form", _hoisted_6, [
          ...
          createBaseVNode("div", { class: "button-container" }, [
            ...
            createBaseVNode("button", { onClick: reveal }, "Reveal"),
            createBaseVNode("button", { onClick: reset }, "Reset")
          ]),
          unref(store).answerRevealed ? (openBlock(), createElementBlock("div", _hoisted_10, [
            _hoisted_11,
            createBaseVNode("span", _hoisted_12, toDisplayString(unref(store).data[unref(store).dataIndex].answer), 1),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        !unref(store).gameRunning ? (openBlock(), createElementBlock("button", {
          key: 0,
          id: "start-btn",
          onClick: startGame
        }, "Start")) : createCommentVNode("", true),
        unref(store).gameRunning ? (openBlock(), createBlock(_sfc_main$1, { key: 1 })) : createCommentVNode("", true)
      ]);
    };
  }
};
