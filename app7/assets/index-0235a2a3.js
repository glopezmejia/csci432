...
const _hoisted_1 = { class: "container mt-3 mt-md-4" };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const client = c("TADb6mVqeiMPIHDgsCJQNIA9a3I5N5Re3IbDMI7lHOD6mSs67OR4Z5MV");
    ...
    function loadImage() {
      ...
      photo.url = (_a = pexelCollection.media[mediaIndex.value].src) == null ? void 0 : _a[mediaIndex.value === 4 ? "portrait" : "landscape"];
    }
