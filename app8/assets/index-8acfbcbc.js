...
const icon = "/app8/assets/icon-e571f3b9.webp";
const CreateAcc_vue_vue_type_style_index_0_lang = "";
const _hoisted_1 = {
  id: "mainContainer",
...
const _hoisted_2 = {
  id: "content",
  class: "row flex-column flex-md-row mx-lg-5 text-center"
};
const _hoisted_3 = { class: "col-md-5" };
const _hoisted_4 = ["src"];
const _hoisted_5 = { class: "row flex-column" };
const _hoisted_6 = { class: "col d-none d-md-block mt-5" };
const _hoisted_7 = { class: "col d-none d-md-block" };
const _hoisted_8 = { id: "userEmail" };
const _hoisted_9 = { class: "col d-none d-md-block" };
const _hoisted_10 = /* @__PURE__ */ createBaseVNode("section", { class: "col-md-2 d-none d-md-block px-0" }, [
...
const _hoisted_13 = { class: "row mt-3 mt-md-0" };
const _hoisted_14 = { class: "col form-floating" };
const _hoisted_15 = /* @__PURE__ */ createBaseVNode("label", { for: "username" }, "Username", -1);
const _hoisted_16 = { class: "row" };
const _hoisted_17 = { class: "col form-floating" };
const _hoisted_18 = /* @__PURE__ */ createBaseVNode("label", { for: "email" }, "Email Address", -1);
          ...
          createBaseVNode("section", _hoisted_3, [
            ...
            createBaseVNode("div", _hoisted_5, [
              createBaseVNode("div", _hoisted_6, [
                createBaseVNode("p", null, toDisplayString(username.value), 1)
              ]),
              createBaseVNode("div", _hoisted_7, [
                createBaseVNode("p", _hoisted_8, toDisplayString(email.value), 1)
              ]),
              createBaseVNode("div", _hoisted_9, [
                createBaseVNode("p", null, toDisplayString(phoneNumber.value), 1)
              ])
            ])
          ]),
          _hoisted_10,
            ...
            createBaseVNode("form", _hoisted_12, [
              ...
              createBaseVNode("div", _hoisted_19, [
                createBaseVNode("div", _hoisted_20, [
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => phoneNumber.value = $event),
                    class: "form-control",
                    type: "tel",
                    id: "phoneNumber",
                    name: "phoneNumber",
...
const _sfc_main = {
  components: {
    CreateAcc: _sfc_main$1
  }
};
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_CreateAcc = resolveComponent("CreateAcc");
  return openBlock(), createBlock(_component_CreateAcc);
}
